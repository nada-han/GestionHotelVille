...
<body>
    ...
    <form action="hotelController" method="post">
        ...
        <button name="action" value="create" class="btn btn-primary">Ajouter</button>
    </form>
    ...
    <c:forEach items="${hotels}" var="h">
        <li class="list-group-item">
            ...
            <form action="hotelController" method="get" class="form-inline">
                ...
                <!-- Bouton Modifier -->
                <button type="submit" name="action" value="update" class="btn btn-warning ml-2">
                    Modifier
                </button>
